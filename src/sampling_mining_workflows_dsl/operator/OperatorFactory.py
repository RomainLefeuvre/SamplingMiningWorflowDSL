...
from sampling_mining_workflows_dsl.operator.selection.sampling.automatic.RandomSelectionPartitionOperator import (
    RandomSelectionPartitionOperator,
)
from sampling_mining_workflows_dsl.operator.selection.sampling.automatic.SystematicRandomSelectionOperator import (
...
from sampling_mining_workflows_dsl.operator.selection.sampling.manual.InteractiveManualSamplingOperator import (
