...
from newDSL2.operator.selection.sampling.automatic.RandomSelectionPartitionOperator import \
    RandomSelectionPartitionOperator
from newDSL2.operator.selection.sampling.automatic.SystematicRandomSelectionOperator import \
    SystematicRandomSelectionOperator
from newDSL2.operator.selection.sampling.automatic.SystematicSelectionOperator import SystematicSelectionOperator
from newDSL2.operator.selection.sampling.manual.InteractiveManualSamplingOperator import \
