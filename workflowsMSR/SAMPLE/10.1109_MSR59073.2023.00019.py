...
def main():
    ...
    automl_fw_extraction = (WorkflowBuilder().input(JsonLoader(input_path,url, topic, stars))
    ...
    downstream_repos_workflow = (WorkflowBuilder().input(JsonLoader(input_path, url, imported_frameworks, is_fork))
