...
def main():
    ...
    workflow1 = (WorkflowBuilder().input(JsonLoader(input_path,url, topic))
    ...
    # Workflow Declaration and Execution
    workflow2 = (WorkflowBuilder().input(JsonLoader(input_path, url, has_VST_plugin))
                .filter_operator("not has_VST_plugin")
                .random_selection_operator(299) # how to get the same distribution as the previous sample?
                .manual_sampling_operator()
                 .output(CsvWriter("out.csv")))
