...
LANGS = ["C", "C++", "C#", "Java", "JavaScript", "PHP", "Python", "Ruby", "Shell", "TypeScript"]
...
workflow = (
    ...
    .grouping_operator(
        *[
            ...
            .systematic_selection_operator(cardinality=10, metadata_name="mergedPullRequests", reverse=True)
            for lang in LANGS
        ]
    )
