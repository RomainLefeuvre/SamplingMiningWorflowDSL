...
class SystematicSelectionOperator(AutomaticSamplingOperator):
    def __init__(self, workflow:Workflow,cardinality: int ,metadata_name:str,reverse=False, step: int=1,order_constraint: Comparator=NaturalComparator):
    ...
    def execute(self) -> Operator:
        self._input.sort_by_metadata(self.metadata_name,self.order_constraint,self.reverse)
